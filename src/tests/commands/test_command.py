...
from src.commands.command import BaseCommand
from src.commands.command import CommandFactory
from src.commands.command import execute_command
from src.commands.command import GoogleCommand
from src.commands.command import MemoryAddCommand
...
class TestCommands:
    ...
    def test_command_factory(self):
        ...
        memory_add_command = CommandFactory.create_command(
            "memory_add", {"memory": "Remember this"}
        )
